...
<head>
    <meta charset="UTF-8">
    <title>Admission Result Notification</title>
                ...
                <tr>
                    <td style="padding:36px 30px; color:#064e3b;">
                        ...
                        <p style="font-size:16px; line-height:1.7; margin:0 0 22px; color:#065f46;">
                            Your <strong>JAMB Admission Result Notification</strong> request has been
                        ...
                        <p style="font-size:16px; line-height:1.7; margin:22px 0;">
                            You can download your admission result notification using the button below:
                        </p>
                                ...
                                <td align="center" style="padding:10px 0 28px;">
                                    <a href="{{ asset('storage/' . $job->result_file) }}"
                                       style="background:#10b981;
                                        ...
                                        ⬇ Download Admission Result Notification
                                    </a>
                                </td>
                            </tr>
                        </table>
