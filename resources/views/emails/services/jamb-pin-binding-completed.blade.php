...
<head>
    <meta charset="UTF-8">
    <title>Pin Binding Notification</title>
                ...
                <tr>
                    <td style="padding:36px 30px; color:#064e3b;">
                        ...
                        <p style="font-size:16px; line-height:1.7; margin:0 0 22px; color:#065f46;">
                            Your <strong>JAMB Pin Binding</strong> request has been
                        ...
                        <p style="font-size:16px; line-height:1.7; margin:22px 0;">
                            You can download your pin binding using the button below:
                        </p>
