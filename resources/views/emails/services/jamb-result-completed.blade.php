...
<head>
    <meta charset="UTF-8">
    <title>JAMB Result Completed</title>
                ...
                <tr>
                    <td style="padding:36px 30px; color:#064e3b;">
                        ...
                        <p style="font-size:16px; line-height:1.7; margin:0 0 18px;">
                            Hello <strong>{{ $job->user->name ?? 'Student' }}</strong>,
                        </p>

                        <p style="font-size:16px; line-height:1.7; margin:0 0 22px; color:#065f46;">
                            Your request for <strong>{{ $job->service->name }}</strong> has been
                            <strong style="color:#10b981;">successfully completed</strong>.<br>
                            The administrator has processed your request and your payment has been confirmed.
                        </p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                ...
                                <td style="padding:14px 16px; background:#f0fdf4;
                                           border-radius:0 10px 10px 0;">
                                    ₦{{ number_format($job->customer_price, 2) }}
                                </td>
                            </tr>
